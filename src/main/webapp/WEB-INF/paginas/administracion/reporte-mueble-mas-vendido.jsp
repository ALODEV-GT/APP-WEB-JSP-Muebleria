...
<h1>REPORTE MUEBLE MAS VENDIDO</h1>
...
<div>
    <a href="${pageContext.request.contextPath}/ServletExportar?reporte=reporteMuebleMasVendido&fechaInicial=${fechaInicial}&fechaFinal=${fechaFinal}">EXPORTAR REPORTE</a>
</div>
